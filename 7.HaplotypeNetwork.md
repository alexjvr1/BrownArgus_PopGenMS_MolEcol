# Haplotype network of results

## Converting bayescan results to Loci


ddRAD loci were sequenced from 300-450bp insert sizes with 150bp PE reads. So we can reconstruct haplotypes with 300-450bp sequences. 
...
### 0. Extract haplotypes

Use this script: [ExtractHaplotypes.sh](https://github.com/alexjvr1/BrownArgus_PopGenMS_MolEcol/blob/main/Scripts/ExtractHaplotypes.sh)
